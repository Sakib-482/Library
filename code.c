...
void saveBooksToFile()
{
    FILE *fp = fopen("R:\\Library management system\\books.txt", "w");
...
void loadBooksFromFile()
{
    FILE *fp = fopen("R:\\Library management system\\books.txt", "r");
...
void aboutUs()
{
    ...
    printf("Developed by :-\n");
    printf("MD. SAKIB.        Id: 24-35-482\n");
    printf("MD. MONIRUJJAMAN ABIR.             Id: 242-35-853\n");
    printf("S.M. MOSSABIRUL ISLAM.   id: 242-35-277\n");
